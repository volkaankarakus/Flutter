...
class _MyHomePageState extends State<MyHomePage> {
  ...
  // *************************** POST UPDATE *************************************** //
  Future<void> userUpdate(int userID,String userName,String userPhone) async{
    var url = Uri.parse("http://kasimadalan.pe.hu/kisiler/update_kisiler.php");
    var data = {"kisi_id":userID.toString(), "kisi_ad":userName, "kisi_tel":userPhone};
    var response = await http.post(url,body: data);
